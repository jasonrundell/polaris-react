...
- Fixed unnecessary height on `TextField` due to how carriage returns were handled when calculating components' height ([#901](https://github.com/Shopify/polaris-react/pull/901))
